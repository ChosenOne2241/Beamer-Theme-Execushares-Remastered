...
\end{cases}
\end{equation*}
And easily we can see that the incidence matrix of $H$ is just the biajacency matrix of the original graph \cite[pp.~22]{tanenbaum2011computer}.
